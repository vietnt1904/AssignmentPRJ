<%-- 
    Document   : login
    Created on : Feb 11, 2025, 3:25:14 PM
    Author     : VIET
--%>
    ...
    <body class="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
        <div class="w-full max-w-md p-8 space-y-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <form action="login" method="POST" class="space-y-4">
                <div class="space-y-2">
                    <label for="email" class="text-sm font-medium text-gray-700 dark:text-gray-200">Account</label>
                    <input id="phone" name="account" required
